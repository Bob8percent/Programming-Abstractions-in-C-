...
int hopCount(Node* n1, Node* n2) {
	...
	while (!q.empty()) {
		...
		for (Arc* a : cp->arcs) {
			...
			hopMap[n] = hopMap[cp] + 1;
			if (n == n2) {
				std::cout << n1->name << "->" << n2->name << std::endl;
				return hopMap[n];
			}
		}
	}
...
int main() {
	...
	std::cout << hopCount(airline.nodeMap["Atlanta"], airline.nodeMap["Denver"]) << std::endl;
	std::cout << hopCount(airline.nodeMap["Atlanta"], airline.nodeMap["Los Angeles"]) << std::endl;
	std::cout << hopCount(airline.nodeMap["Atlanta"], airline.nodeMap["New York"]) << std::endl;
	std::cout << hopCount(airline.nodeMap["Atlanta"], airline.nodeMap["Boston"]) << std::endl;
	std::cout << hopCount(airline.nodeMap["Atlanta"], airline.nodeMap["Seattle"]) << std::endl;
	std::cout << hopCount(airline.nodeMap["Atlanta"], airline.nodeMap["Portland"]) << std::endl;
	std::cout << hopCount(airline.nodeMap["Atlanta"], airline.nodeMap["San Francisco"]) << std::endl;
